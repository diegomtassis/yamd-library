...
void initPrinter() { printer_on = FALSE; }
...
static void cursorOn() { cursorUpdate(); }
...
static u16 tilesToPx(u16 tiles) { return tiles * 8; }

static u16 pxToTiles(u16 px) { return px / 8; }
